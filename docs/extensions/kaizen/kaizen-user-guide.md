...
The agent builder walks you through configuration in a few steps.
...
- **Model** — Select an AI model deployed on your Kamiwaza instance. Models are managed by your admin through the [Kamiwaza Model Library](https://docs.kamiwaza.ai/models/overview).
...
Skills extend what your agent can produce. Select from prebuilt skills or upload your own.

![Prebuilt skills](/img/extensions/kaizen/onboarding-03-skills.png)
...
You can also upload custom skills as a .zip file. Custom skills follow the [Open Skills Standard](https://agentskills.io/home), an open specification for extending AI agent capabilities with domain-specific knowledge and workflows.
...
### Step 3: Connecting Tools (MCP Integrations)
...
Tools deployed through the [Kamiwaza Tool Shed](https://docs.kamiwaza.ai/tool-garden) are **automatically available** for selection here. Your admin deploys tools to the platform, and they appear ready to attach to your agents.
...
The **Risk Threshold** (Low / Medium / High) determines the cutoff. With Medium selected, the agent will ask for confirmation on medium and high risk actions but proceed autonomously on low-risk ones.
...
- **Private Chat** — Start an ephemeral conversation that is automatically deleted when you're done. Useful for sensitive or one-off tasks.
- **Configure** — Edit the agent's model, skills, tools, or security policy.
...
Click the **+** button in the message input to attach files. You can upload from your local device or pull files directly from **Microsoft 365 tools** (OneDrive, SharePoint).

![File upload options](/img/extensions/kaizen/onboarding-08-file-upload.png)

> **Note:** The M365 connector must be configured by an administrator in the Kamiwaza UI before it's available to users. Once configured, you can browse and attach OneDrive and SharePoint files directly in your conversations.
...
- **Use Skills** — Attach prebuilt skills for common outputs (charts, PDFs, presentations) and teach Kaizen to build new ones.
...
- **Models:** [docs.kamiwaza.ai/models/overview](https://docs.kamiwaza.ai/models/overview)
- **Tool Shed:** [docs.kamiwaza.ai/tool-garden](https://docs.kamiwaza.ai/tool-garden)
- **Open Skills Standard:** [agentskills.io/home](https://agentskills.io/home)
