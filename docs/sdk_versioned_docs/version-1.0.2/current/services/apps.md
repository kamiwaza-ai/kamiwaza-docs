...
- **[Extensions Service](./extensions)** - The recommended replacement for App Garden (K8s-native extensions)
- [Example Notebook](https://github.com/kamiwaza-ai/kamiwaza-sdk/blob/main/examples/08_app_garden_and_tools.ipynb) - Legacy examples of App Garden usage
- [Tool Service](./tools) - Deploy MCP Tool servers (also deprecated)