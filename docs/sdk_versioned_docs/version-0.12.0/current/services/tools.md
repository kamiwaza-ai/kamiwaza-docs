...
>
> See the [Extensions Service documentation](./extensions) for full details.
...
- **[Extensions Service](./extensions)** - The recommended replacement for Tool Shed (K8s-native extensions)
- [Example Notebook](https://github.com/kamiwaza-ai/kamiwaza-sdk/blob/main/examples/08_app_garden_and_tools.ipynb) - Legacy examples of Tool Shed usage
- [App Service](./apps) - Deploy containerized applications (also deprecated)
- [Authentication Guide](./auth) - Setting up authentication